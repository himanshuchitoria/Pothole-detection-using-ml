...
size = 300
model = Sequential()
model = load_model("C:/Users/Himanshu Chitoria/latest_full_model.h5")
...
potholeTestImages = glob.glob("C:/Users/Himanshu Chitoria/Downloads/pothole-detection-system-using-convolution-neural-networks/My Dataset/test/Pothole/*.jpg")
# nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.jpeg"))
# nonPotholeTrainImages.extend(glob.glob("C:/Users/anant/Desktop/pothole-and-plain-rode-images/My Dataset/train/Plain/*.png"))
